          ...
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12">
            <div className="space-y-5 lg:col-span-7">
              ...
              <div className="pt-2">
                <Link
                  href="#library"
                  className="inline-flex items-center gap-2 rounded-md bg-[#c8ff00] px-6 py-3.5 text-xs font-black tracking-wider text-black transition-all hover:bg-[#b5e600] active:scale-95"
                >
